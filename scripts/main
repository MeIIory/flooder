...
function showEditConfigDialog(config, index) {
    ...
    buttonTable.add(saveBtn).size(60, 50).pad(5);
...
function showConfigDialog() {
    ...
    if(configList.length > 0) {
        ...
        configList.forEach((config, index) => {
            ...
            table.add(loadBtn).size(50, 40).pad(2);
            ...
            table.add(editBtn).size(50, 40).pad(2);
    ...
    configDialog.cont.add(createBtn).size(250, 50).row();
...
function showCreateConfigDialog() {
    let createDialog = new BaseDialog("");
    ...
    createDialog.cont.add(saveBtn).size(60, 50).row();
    ...
    createDialog.cont.add(cancelBtn).size(80, 40);
